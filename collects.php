...
<head>
    ...
    <title>Collects - Common Prayer Online</title>
...
<section class="container cpo-body-padding-top">
    <div class="row">
        <div class="col-12 pt-5 text-center">
            <h1 class="cpo-content-page-title">COLLECTS</h1>
        ...
        <div class="col-lg-12 mt-3">
            <blockquote  id="text-container">
                <div class="text-center"><h3>COLLECTS.</h3></div>
                <div class="text-center">
                    <small><i>To be used after the Collects of Morning or Evening Prayer, or Communion, at
                        the discretion of the Minister.</i></small>
                </div>
                <b>
                    O LORD Jesus Christ, who saidst unto thine Apostles,
                    Peace I leave with you, my peace I give unto you; Regard
                    not our sins, but the faith of thy Church; and grant to it
                    that peace and unity which is according to thy will, who
                    livest and reignest with the Father and the Holy Ghost,
                    one God, world without end.  <i>Amen.</i><br/>
                    <br/>
                    <br/>

                    ASSIST us mercifully, O Lord, in these our supplications
                    and prayers, and dispose the way of thy servants towards
                    the attainment of everlasting salvation; that, among all
                    the changes and chances of this mortal life, they may
                    ...
                    living, to the honour and praise of thy Name; through
